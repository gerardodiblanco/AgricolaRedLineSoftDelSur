...
export class NuevoSubCuartelComponent {
  ...
  pathsSubCuartel: Array<LatLngLiteral> = new Array<LatLngLiteral>();
  markers: marker[] = [];
  latInicio = -32.880913;
  lngInicio = -68.83319;
  editable: boolean;
...
//guardar 
  ...
  elimiarSubCuartel() {
    for (var index = 0; index < this.subcuarteles.length; index++) {
      var element = this.subcuarteles[index];
